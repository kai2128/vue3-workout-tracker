  ...
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    <div v-if="dataLoaded">
      ...
      >
        <div
          v-if="user"
          class="flex absolute left-2 top-2 gap-x-2 text-at-light-green text-lg"
        >
          <ph:trash-duotone
        ...
        <p
          class="mt-6 py-1.5 px-3 text-xs text-white bg-at-light-green shadow-md rounded-lg"
        >
          {{ data.type }}
        </p>
      </div>
    ...
    <div v-else>
      <span class="text-xl text-gray-600"
        >The workout you are looking is not available.</span
      >
    </div>
  </div>
</template>
