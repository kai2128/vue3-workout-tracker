    ...
    <div class="max-w-screen-sm mx-auto px-4 py-10">
        <div v-if="dataLoaded">
            ...
            <div v-if="data.type == 'strength'" class="flex flex-col gap-y-4 w-full">
              <div class="flex flex-col gap-x-6 gap-y-2 relative sm:flex-row" v-for="(item, index) in data.exercises" :key="item.id">
                ...
                <button v-if="editMode" type="button" @click="addExercise" class="btn self-start">
                  Add Exercise
                </button>
              </div>
            </div>
